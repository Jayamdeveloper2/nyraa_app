            ...
            child: Padding(
              ...
              child: GridView.builder(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2,
                  childAspectRatio: 0.58, // Adjusted for better image visibility and layout
                  crossAxisSpacing: 12,
                  mainAxisSpacing: 12,
                ),
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Stack(
                              children: [
                                SizedBox(
                                  height: 180, // Height as per previous update
                                  width: double.infinity, // Ensures full width
                                  child: Image.asset(
                                    product.image,
                                    fit: BoxFit.cover, // Fills the width and height
                          ...
                          const SizedBox(height: 12), // Gap between content and button
                          AddToCartButton(
                            onPressed: () {
