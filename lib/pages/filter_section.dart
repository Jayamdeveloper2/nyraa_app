...
class _FilterBottomSheetState extends State<FilterBottomSheet> {
  ...
  void handleCheckboxChange(String category, String value) {
    setState(() {
      final List<String> categoryFilters = List.from(filters[category]);
  ...
  @override
  Widget build(BuildContext context) { // Fixed typo: BuildContextContext -> BuildContext
                  ...
                  ...filterOptions['availability']!
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Checkbox(
                            value: filters['availability'].contains(option['value']),
                    ...
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          controller: TextEditingController(text: filters['priceRange']['min'].toString()),
                        ),
                      ),
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          controller: TextEditingController(text: filters['priceRange']['max'].toString()),
                        ),
                      ),
                    ],
                  ),
                  ...
                  ...filterOptions['size']!.map<Widget>((option) {
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Checkbox(
                            value: filters['size'].contains(option['value']),
                            onChanged: (bool? value) {
                  ...
                  ...filterOptions['style']!.map<Widget>((option) {
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Checkbox(
                            value: filters['style'].contains(option['value']),
                            onChanged: (bool? value) {
                  ...
                  ...filterOptions['material']!.map<Widget>((option) {
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Checkbox(
                            value: filters['material'].contains(option['value']),
                            onChanged: (bool? value) {
                  ...
                  ...filterOptions['brand']!.map<Widget>((option) {
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          Checkbox(
                            value: filters['brand'].contains(option['value']),
                            onChanged: (bool? value) {
